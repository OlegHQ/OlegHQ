...
- **[notion-calendar-cli](https://github.com/OlegHQ/notion-calendar-cli)** — Agent-oriented Rust CLI for Notion Calendar automation over characterized Notion Calendar API surfaces
